...
public class ZFile {
	...
	public static String getPath(String s) {
		String t = ZFile.class.getResource("").toString();

		// Remove file:/ and everything before it
		String res = t.replaceAll("^.*file:/", "");

		// Replace /classes/ and everything after it (for Windows)
		res = res.replaceAll("/classes/.*", "/classes/");

		// Replace /target/ and everything after it (for Linux)
		res = res.replaceAll("/target/.*", "/target/classes/");

		// Add / before app (for Linux)
		res = res.replaceAll("app/", "/app/");
