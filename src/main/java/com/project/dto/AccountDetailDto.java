...
public class AccountDetailDto {
	 ...
	 * @return
	 */
	public static AccountDetailDto convert(Object[] o) {
	 ...
	 * @return
	 */
	public static List<AccountDetailDto> convert(List<Object[]> l) {
		List<AccountDetailDto> res = new ArrayList<AccountDetailDto>();
